...
public interface WorkflowService {
     ...
     *                          1: 指定任务或资源不存在 <br>
     */
    Form getForm(String processId, String itemName) throws ServiceException;
     ...
     *                          2: 指定任务不存在 <br>
     */
    void updateForm(String processId, String formName, Form formData) throws ServiceException;
